...
public class StudentController {
	...
	@PostMapping("create")
	public String create(Model model, Pagination pagination, @Valid Student student, BindingResult bindingResult) {
	...
	public String edit(Model model, Pagination pagination, @Valid Student student, BindingResult bindingResult) {
		if(bindingResult.hasErrors()) {
			model.addAttribute("departments", departmentMapper.findAll());
			return "student/edit";
		}
