...
<body>
	<div class="container">
		<form:form method="post" modelAttribute="person">
			<div class="title">Person ${ person.pid > 0 ? "수정" : "등록" }</div>
			<table>
				<tr>
					<td>이름:</td>
				...
				<tr>
					<td>학과:</td>
					<td><form:select path="categoryCode" itemValue="code"
				...
				<tr>
					<td>성별:</td>
					<td><form:radiobutton path="gender" value="남" label="남자" /> <form:radiobutton
							path="gender" value="여" label="여자" /></td>
