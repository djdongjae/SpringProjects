...
public class PersonController {
	...
	@Autowired net.skhu.mapper.CategoryMapper categoryMapper;
	...
	@PostMapping("create")
	public String create(Model model, Pagination pagination, @Valid Person person, BindingResult bindingResult) {
	...
	public String edit(Model model, Pagination pagination, @Valid Person person, BindingResult bindingResult) {
		if(bindingResult.hasErrors()) {
			model.addAttribute("categories", categoryMapper.findAll());
			return "person/edit";
		}
