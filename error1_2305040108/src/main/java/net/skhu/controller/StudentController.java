...
public class StudentController {
    ...
    public String edit(Model model, Pagination pagination,
    	...
    	try {
    		...
    		bindingResult.reject("error", "저장실패");
    ...
    public String delete(Model model, @RequestParam("id") int id, Pagination pagination, @Valid Student student, BindingResult bindingResult) {
    	try {
